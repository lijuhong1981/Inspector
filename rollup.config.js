...
export default [
    output('./dist/', 'inspector.js', 'umd', true, true),
    output('./dist/', 'inspector.esm.js', 'esm', true, false),
    output('./dist/', 'inspector.min.js', 'umd', false, false),
    output('./dist/', 'inspector.esm.min.js', 'esm', false, false),
]